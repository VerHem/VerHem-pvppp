...
appendAttributes2Display.OSPRayScaleArray = 'SxcurrK3'
...
appendAttributes2Display.SetScaleArray = ['POINTS', 'SxcurrK3']
appendAttributes2Display.ScaleTransferFunction = 'PiecewiseFunction'
appendAttributes2Display.OpacityArray = ['POINTS', 'SxcurrK3']
...
appendAttributes2Display.OpacityArrayName = ['POINTS', 'SxcurrK3']
...
mergeVectorComponents2.XArray = 'SxcurrK3X'

# Properties modified on mergeVectorComponents2
mergeVectorComponents2.YArray = 'SxcurrK3Y'
mergeVectorComponents2.ZArray = 'SxcurrK3Z'
mergeVectorComponents2.OutputVectorName = 'SxcurrK3'
...
mergeVectorComponents2Display.OSPRayScaleArray = 'SxcurrK1'
...
mergeVectorComponents2Display.SetScaleArray = ['POINTS', 'SxcurrK3']
mergeVectorComponents2Display.ScaleTransferFunction = 'PiecewiseFunction'
mergeVectorComponents2Display.OpacityArray = ['POINTS', 'SxcurrK3']
...
mergeVectorComponents2Display.OpacityArrayName = ['POINTS', 'SxcurrK3']
