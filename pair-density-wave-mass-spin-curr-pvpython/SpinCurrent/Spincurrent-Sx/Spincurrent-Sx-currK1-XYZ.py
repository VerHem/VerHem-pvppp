...
## spin current K1 Sx contribution formilism:
...
pythonCalculator19.Expression = "inputs[0].PointData['u_31']*inputs[4].PointData['u_i21'][:,0]-inputs[0].PointData['u_21']*inputs[7].PointData['u_i31'][:,0]+inputs[0].PointData['u_31']*inputs[5].PointData['u_i22'][:,1]-inputs[0].PointData['u_21']*inputs[8].PointData['u_i32'][:,1]+inputs[0].PointData['u_31']*inputs[6].PointData['u_i23'][:,2]-inputs[0].PointData['u_21']*inputs[9].PointData['u_i33'][:,2]+inputs[0].PointData['v_31']*inputs[13].PointData['v_i21'][:,0]-inputs[0].PointData['v_21']*inputs[16].PointData['v_i31'][:,0]+inputs[0].PointData['v_31']*inputs[14].PointData['v_i22'][:,1]-inputs[0].PointData['v_21']*inputs[17].PointData['v_i32'][:,1]+inputs[0].PointData['v_31']*inputs[15].PointData['v_i23'][:,2]-inputs[0].PointData['v_21']*inputs[18].PointData['v_i33'][:,2]"

pythonCalculator19.ArrayName = 'SxcurrK1X'
...
pythonCalculator19Display.OSPRayScaleArray = 'SxcurrK1X'
...
pythonCalculator19Display.SetScaleArray = ['POINTS', 'SxcurrK1X']
pythonCalculator19Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator19Display.OpacityArray = ['POINTS', 'SxcurrK1X']
...
pythonCalculator19Display.OpacityArrayName = ['POINTS', 'SxcurrK1X']
...
pythonCalculator20.Expression = "inputs[0].PointData['u_32']*inputs[4].PointData['u_i21'][:,0]-inputs[0].PointData['u_22']*inputs[7].PointData['u_i31'][:,0]+inputs[0].PointData['u_32']*inputs[5].PointData['u_i22'][:,1]-inputs[0].PointData['u_22']*inputs[8].PointData['u_i32'][:,1]+inputs[0].PointData['u_32']*inputs[6].PointData['u_i23'][:,2]-inputs[0].PointData['u_22']*inputs[9].PointData['u_i33'][:,2]+inputs[0].PointData['v_32']*inputs[13].PointData['v_i21'][:,0]-inputs[0].PointData['v_22']*inputs[16].PointData['v_i31'][:,0]+inputs[0].PointData['v_32']*inputs[14].PointData['v_i22'][:,1]-inputs[0].PointData['v_22']*inputs[17].PointData['v_i32'][:,1]+inputs[0].PointData['v_32']*inputs[15].PointData['v_i23'][:,2]-inputs[0].PointData['v_22']*inputs[18].PointData['v_i33'][:,2]"


pythonCalculator20.ArrayName = 'SxcurrK1Y'
...
pythonCalculator20Display.OSPRayScaleArray = 'SxcurrK1Y'
...
pythonCalculator20Display.SetScaleArray = ['POINTS', 'SxcurrK1Y']
pythonCalculator20Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator20Display.OpacityArray = ['POINTS', 'SxcurrK1Y']
...
pythonCalculator20Display.OpacityArrayName = ['POINTS', 'SxcurrK1Y']
...
# Properties modified on pythonCalculator19, i = 3 i.e., z
pythonCalculator21.Expression = "inputs[0].PointData['u_33']*inputs[4].PointData['u_i21'][:,0]-inputs[0].PointData['u_23']*inputs[7].PointData['u_i31'][:,0]+inputs[0].PointData['u_33']*inputs[5].PointData['u_i22'][:,1]-inputs[0].PointData['u_23']*inputs[8].PointData['u_i32'][:,1]+inputs[0].PointData['u_33']*inputs[6].PointData['u_i23'][:,2]-inputs[0].PointData['u_23']*inputs[9].PointData['u_i33'][:,2]+inputs[0].PointData['v_33']*inputs[13].PointData['v_i21'][:,0]-inputs[0].PointData['v_23']*inputs[16].PointData['v_i31'][:,0]+inputs[0].PointData['v_33']*inputs[14].PointData['v_i22'][:,1]-inputs[0].PointData['v_23']*inputs[17].PointData['v_i32'][:,1]+inputs[0].PointData['v_33']*inputs[15].PointData['v_i23'][:,2]-inputs[0].PointData['v_23']*inputs[18].PointData['v_i33'][:,2]"


pythonCalculator21.ArrayName = 'SxcurrK1Z'
...
pythonCalculator21Display.OSPRayScaleArray = 'SxcurrK1Z'
...
pythonCalculator21Display.SetScaleArray = ['POINTS', 'SxcurrK1Z']
pythonCalculator21Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator21Display.OpacityArray = ['POINTS', 'SxcurrK1Z']
...
pythonCalculator21Display.OpacityArrayName = ['POINTS', 'SxcurrK1Z']
