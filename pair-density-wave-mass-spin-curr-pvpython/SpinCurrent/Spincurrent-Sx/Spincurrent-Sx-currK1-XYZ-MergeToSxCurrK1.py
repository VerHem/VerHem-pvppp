...
appendAttributes1Display.OSPRayScaleArray = 'SxcurrK1'
...
appendAttributes1Display.SetScaleArray = ['POINTS', 'SxcurrK1']
appendAttributes1Display.ScaleTransferFunction = 'PiecewiseFunction'
appendAttributes1Display.OpacityArray = ['POINTS', 'SxcurrK1']
...
appendAttributes1Display.OpacityArrayName = ['POINTS', 'SxcurrK1']
...
mergeVectorComponents1.XArray = 'SxcurrK1X'
#mergeVectorComponents1.YArray = 'SxcurrK1X'
#mergeVectorComponents1.ZArray = 'SxcurrK1X'

# Properties modified on mergeVectorComponents1
mergeVectorComponents1.YArray = 'SxcurrK1Y'
mergeVectorComponents1.ZArray = 'SxcurrK1Z'
mergeVectorComponents1.OutputVectorName = 'SxcurrK1'
...
mergeVectorComponents1Display.OSPRayScaleArray = 'SxcurrK1'
...
mergeVectorComponents1Display.SetScaleArray = ['POINTS', 'SxcurrK1']
mergeVectorComponents1Display.ScaleTransferFunction = 'PiecewiseFunction'
mergeVectorComponents1Display.OpacityArray = ['POINTS', 'SxcurrK1']
...
mergeVectorComponents1Display.OpacityArrayName = ['POINTS', 'SxcurrK1']
