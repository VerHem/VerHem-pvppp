...
pythonCalculator23.Expression = "inputs[0].PointData['u_31']*inputs[4].PointData['u_i21'][:,0]-inputs[0].PointData['u_21']*inputs[7].PointData['u_i31'][:,0]+inputs[0].PointData['u_32']*inputs[4].PointData['u_i21'][:,1]-inputs[0].PointData['u_22']*inputs[7].PointData['u_i31'][:,1]+inputs[0].PointData['u_33']*inputs[4].PointData['u_i21'][:,2]-inputs[0].PointData['u_23']*inputs[7].PointData['u_i31'][:,2]+inputs[0].PointData['v_31']*inputs[13].PointData['v_i21'][:,0]-inputs[0].PointData['v_21']*inputs[16].PointData['v_i31'][:,0]+inputs[0].PointData['v_32']*inputs[13].PointData['v_i21'][:,1]-inputs[0].PointData['v_22']*inputs[16].PointData['v_i31'][:,1]+inputs[0].PointData['v_33']*inputs[13].PointData['v_i21'][:,2]-inputs[0].PointData['v_23']*inputs[16].PointData['v_i31'][:,2]"

pythonCalculator23.ArrayName = 'SxcurrK3X'
...
# pythonCalculator23Display.OSPRayScaleArray = 'SxcurrK3X'
...
# pythonCalculator23Display.SetScaleArray = ['POINTS', 'SxcurrK3X']
# pythonCalculator23Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator23Display.OpacityArray = ['POINTS', 'SxcurrK3X']
...
# pythonCalculator23Display.OpacityArrayName = ['POINTS', 'SxcurrK3X']
...
pythonCalculator24.ArrayName = 'SxcurrK3Y'
...
# pythonCalculator24Display.OSPRayScaleArray = 'SxcurrK3Y'
...
# pythonCalculator24Display.SetScaleArray = ['POINTS', 'SxcurrK3Y']
# pythonCalculator24Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator24Display.OpacityArray = ['POINTS', 'SxcurrK3Y']
...
# pythonCalculator24Display.OpacityArrayName = ['POINTS', 'SxcurrK3Y']
...
pythonCalculator25.ArrayName = 'SxcurrK3Z'
...
# pythonCalculator25Display.OSPRayScaleArray = 'SxcurrK3Z'
...
# pythonCalculator25Display.SetScaleArray = ['POINTS', 'SxcurrK3Z']
# pythonCalculator25Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator25Display.OpacityArray = ['POINTS', 'SxcurrK3Z']
...
# pythonCalculator25Display.OpacityArrayName = ['POINTS', 'SxcurrK3Z']
