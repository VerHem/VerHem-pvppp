...
# spin current Sz K3 contribution formilism:
# u21 u11i - u11 u12i + u22 u21i
# -u12 u22i + u23 u31i - u13 u32i

# +v21 v11i - v11 v12i + v22 v21i
# -v12 v22i + v23 v31i - v13 v32i

# Properties modified on pythonCalculator23, i = 1 i.e., X
pythonCalculator23.Expression = "inputs[0].PointData['u_21']*inputs[1].PointData['u_i11'][:,0]-inputs[0].PointData['u_11']*inputs[4].PointData['u_i21'][:,0]+inputs[0].PointData['u_22']*inputs[1].PointData['u_i11'][:,1]-inputs[0].PointData['u_12']*inputs[4].PointData['u_i21'][:,1]+inputs[0].PointData['u_23']*inputs[1].PointData['u_i11'][:,2]-inputs[0].PointData['u_13']*inputs[4].PointData['u_i21'][:,2]+inputs[0].PointData['v_21']*inputs[10].PointData['v_i11'][:,0]-inputs[0].PointData['v_11']*inputs[13].PointData['v_i21'][:,0]+inputs[0].PointData['v_22']*inputs[10].PointData['v_i11'][:,1]-inputs[0].PointData['v_12']*inputs[13].PointData['v_i21'][:,1]+inputs[0].PointData['v_23']*inputs[10].PointData['v_i11'][:,2]-inputs[0].PointData['v_13']*inputs[13].PointData['v_i21'][:,2]"

pythonCalculator23.ArrayName = 'SzcurrK3X'
...
# pythonCalculator23Display.OSPRayScaleArray = 'SzcurrK3X'
...
# pythonCalculator23Display.SetScaleArray = ['POINTS', 'SzcurrK3X']
# pythonCalculator23Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator23Display.OpacityArray = ['POINTS', 'SzcurrK3X']
...
# pythonCalculator23Display.OpacityArrayName = ['POINTS', 'SzcurrK3X']
...
pythonCalculator24.Expression = "inputs[0].PointData['u_21']*inputs[2].PointData['u_i12'][:,0]-inputs[0].PointData['u_11']*inputs[5].PointData['u_i22'][:,0]+inputs[0].PointData['u_22']*inputs[2].PointData['u_i12'][:,1]-inputs[0].PointData['u_12']*inputs[5].PointData['u_i22'][:,1]+inputs[0].PointData['u_23']*inputs[2].PointData['u_i12'][:,2]-inputs[0].PointData['u_13']*inputs[5].PointData['u_i22'][:,2]+inputs[0].PointData['v_21']*inputs[11].PointData['v_i12'][:,0]-inputs[0].PointData['v_11']*inputs[14].PointData['v_i22'][:,0]+inputs[0].PointData['v_22']*inputs[11].PointData['v_i12'][:,1]-inputs[0].PointData['v_12']*inputs[14].PointData['v_i22'][:,1]+inputs[0].PointData['v_23']*inputs[11].PointData['v_i12'][:,2]-inputs[0].PointData['v_13']*inputs[14].PointData['v_i22'][:,2]"

pythonCalculator24.ArrayName = 'SzcurrK3Y'
...
# pythonCalculator24Display.OSPRayScaleArray = 'SzcurrK3Y'
...
# pythonCalculator24Display.SetScaleArray = ['POINTS', 'SzcurrK3Y']
# pythonCalculator24Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator24Display.OpacityArray = ['POINTS', 'SzcurrK3Y']
...
# pythonCalculator24Display.OpacityArrayName = ['POINTS', 'SzcurrK3Y']
...
pythonCalculator25.Expression = "inputs[0].PointData['u_21']*inputs[3].PointData['u_i13'][:,0]-inputs[0].PointData['u_11']*inputs[6].PointData['u_i23'][:,0]+inputs[0].PointData['u_22']*inputs[3].PointData['u_i13'][:,1]-inputs[0].PointData['u_12']*inputs[6].PointData['u_i23'][:,1]+inputs[0].PointData['u_23']*inputs[3].PointData['u_i13'][:,2]-inputs[0].PointData['u_13']*inputs[6].PointData['u_i23'][:,2]+inputs[0].PointData['v_21']*inputs[12].PointData['v_i13'][:,0]-inputs[0].PointData['v_11']*inputs[15].PointData['v_i23'][:,0]+inputs[0].PointData['v_22']*inputs[12].PointData['v_i13'][:,1]-inputs[0].PointData['v_12']*inputs[15].PointData['v_i23'][:,1]+inputs[0].PointData['v_23']*inputs[12].PointData['v_i13'][:,2]-inputs[0].PointData['v_13']*inputs[15].PointData['v_i23'][:,2]"


pythonCalculator25.ArrayName = 'SzcurrK3Z'
...
# pythonCalculator25Display.OSPRayScaleArray = 'SzcurrK3Z'
...
# pythonCalculator25Display.SetScaleArray = ['POINTS', 'SzcurrK3Z']
# pythonCalculator25Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator25Display.OpacityArray = ['POINTS', 'SzcurrK3Z']
...
# pythonCalculator25Display.OpacityArrayName = ['POINTS', 'SzcurrK3Z']
