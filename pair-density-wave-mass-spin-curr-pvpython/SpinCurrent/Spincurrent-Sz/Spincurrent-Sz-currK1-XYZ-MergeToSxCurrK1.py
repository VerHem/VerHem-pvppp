...
# appendAttributes1Display.OSPRayScaleArray = 'SzcurrK1'
...
# appendAttributes1Display.SetScaleArray = ['POINTS', 'SzcurrK1']
# appendAttributes1Display.ScaleTransferFunction = 'PiecewiseFunction'
# appendAttributes1Display.OpacityArray = ['POINTS', 'SzcurrK1']
...
# appendAttributes1Display.OpacityArrayName = ['POINTS', 'SzcurrK1']
...
mergeVectorComponents1.XArray = 'SzcurrK1X'

# Properties modified on mergeVectorComponents1
mergeVectorComponents1.YArray = 'SzcurrK1Y'
mergeVectorComponents1.ZArray = 'SzcurrK1Z'
mergeVectorComponents1.OutputVectorName = 'SzcurrK1'
...
# mergeVectorComponents1Display.OSPRayScaleArray = 'SzcurrK1'
...
# mergeVectorComponents1Display.SetScaleArray = ['POINTS', 'SzcurrK1']
# mergeVectorComponents1Display.ScaleTransferFunction = 'PiecewiseFunction'
# mergeVectorComponents1Display.OpacityArray = ['POINTS', 'SzcurrK1']
...
# mergeVectorComponents1Display.OpacityArrayName = ['POINTS', 'SzcurrK1']
