...
# u21 ui11 + u22 ui12 + u23 ui13
# - u11 ui21 - u12 ui22 -u13 ui23

# + v21 vi11 + v22 vi12 + v23 vi13
# - v11 vi21 - v12 vi22 - v13 vi23



# Properties modified on pythonCalculator22
pythonCalculator22.Expression = "inputs[0].PointData['u_21']*inputs[1].PointData['u_i11']+inputs[0].PointData['u_22']*inputs[2].PointData['u_i12']+inputs[0].PointData['u_23']*inputs[3].PointData['u_i13']-inputs[0].PointData['u_11']*inputs[4].PointData['u_i21']-inputs[0].PointData['u_12']*inputs[5].PointData['u_i22']-inputs[0].PointData['u_13']*inputs[6].PointData['u_i23']+inputs[0].PointData['v_21']*inputs[10].PointData['v_i11']+inputs[0].PointData['v_22']*inputs[11].PointData['v_i12']+inputs[0].PointData['v_23']*inputs[12].PointData['v_i13']-inputs[0].PointData['v_11']*inputs[13].PointData['v_i21']-inputs[0].PointData['v_12']*inputs[14].PointData['v_i22']-inputs[0].PointData['v_13']*inputs[15].PointData['v_i23']"

pythonCalculator22.ArrayName = 'SzcurrK2'
...
# pythonCalculator22Display.OSPRayScaleArray = 'SzcurrK2'
...
# pythonCalculator22Display.SetScaleArray = ['POINTS', 'SzcurrK2']
# pythonCalculator22Display.ScaleTransferFunction = 'PiecewiseFunction'
# pythonCalculator22Display.OpacityArray = ['POINTS', 'SzcurrK2']
...
# pythonCalculator22Display.OpacityArrayName = ['POINTS', 'SzcurrK2']
