...
# appendAttributes2Display.OSPRayScaleArray = 'SzcurrK3'
...
# appendAttributes2Display.SetScaleArray = ['POINTS', 'SzcurrK3']
# appendAttributes2Display.ScaleTransferFunction = 'PiecewiseFunction'
# appendAttributes2Display.OpacityArray = ['POINTS', 'SzcurrK3']
...
# appendAttributes2Display.OpacityArrayName = ['POINTS', 'SzcurrK3']
...
mergeVectorComponents2.XArray = 'SzcurrK3X'

# Properties modified on mergeVectorComponents2
mergeVectorComponents2.YArray = 'SzcurrK3Y'
mergeVectorComponents2.ZArray = 'SzcurrK3Z'
mergeVectorComponents2.OutputVectorName = 'SzcurrK3'
...
# mergeVectorComponents2Display.OSPRayScaleArray = 'SzcurrK3'
...
# mergeVectorComponents2Display.SetScaleArray = ['POINTS', 'SzcurrK3']
# mergeVectorComponents2Display.ScaleTransferFunction = 'PiecewiseFunction'
# mergeVectorComponents2Display.OpacityArray = ['POINTS', 'SzcurrK3']
...
# mergeVectorComponents2Display.OpacityArrayName = ['POINTS', 'SzcurrK3']
