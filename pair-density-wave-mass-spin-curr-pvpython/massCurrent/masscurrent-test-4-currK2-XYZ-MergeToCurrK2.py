...
appendAttributes1 = AppendAttributes(registrationName='AppendAttributes1', Input=[pythonCalculator20, pythonCalculator21, pythonCalculator22])
...
appendAttributes1Display.OSPRayScaleArray = 'currK2X'
...
appendAttributes1Display.SetScaleArray = ['POINTS', 'currK2X']
appendAttributes1Display.ScaleTransferFunction = 'PiecewiseFunction'
appendAttributes1Display.OpacityArray = ['POINTS', 'currK2X']
...
appendAttributes1Display.OpacityArrayName = ['POINTS', 'currK2X']
...
mergeVectorComponents1.XArray = 'currK2X'
mergeVectorComponents1.YArray = 'currK2X'
mergeVectorComponents1.ZArray = 'currK2X'

# Properties modified on mergeVectorComponents1
mergeVectorComponents1.YArray = 'currK2Y'
mergeVectorComponents1.ZArray = 'currK2Z'
mergeVectorComponents1.OutputVectorName = 'currK2'
...
mergeVectorComponents1Display.OSPRayScaleArray = 'currK2'
...
mergeVectorComponents1Display.SetScaleArray = ['POINTS', 'currK2']
mergeVectorComponents1Display.ScaleTransferFunction = 'PiecewiseFunction'
mergeVectorComponents1Display.OpacityArray = ['POINTS', 'currK2']
...
mergeVectorComponents1Display.OpacityArrayName = ['POINTS', 'currK2']
