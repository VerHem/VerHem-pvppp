...
pythonCalculator15Display.OSPRayScaleArray = 'u_i23'
...
pythonCalculator15Display.SetScaleArray = ['POINTS', 'u_i23']
pythonCalculator15Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator15Display.OpacityArray = ['POINTS', 'u_i23']
...
pythonCalculator15Display.OpacityArrayName = ['POINTS', 'u_i23']

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
pythonCalculator15Display.ScaleTransferFunction.Points = [-0.050906638872055786, 0.0, 0.5, 0.0, 0.05166671389625186, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
pythonCalculator15Display.OpacityTransferFunction.Points = [-0.050906638872055786, 0.0, 0.5, 0.0, 0.05166671389625186, 1.0, 0.5, 0.0]
...
pythonCalculator16Display.OSPRayScaleArray = 'u_i31'
...
pythonCalculator16Display.SetScaleArray = ['POINTS', 'u_i31']
pythonCalculator16Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator16Display.OpacityArray = ['POINTS', 'u_i31']
...
pythonCalculator16Display.OpacityArrayName = ['POINTS', 'u_i31']
...
pythonCalculator17Display.SetScaleArray = ['POINTS', 'u_i32']
pythonCalculator17Display.ScaleTransferFunction = 'PiecewiseFunction'
pythonCalculator17Display.OpacityArray = ['POINTS', 'u_i32']
...
pythonCalculator17Display.OpacityArrayName = ['POINTS', 'u_i32']
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
pythonCalculator18Display.ScaleTransferFunction.Points = [-0.2046630041939872, 0.0, 0.5, 0.0, 0.20455077943347755, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
pythonCalculator18Display.OpacityTransferFunction.Points = [-0.2046630041939872, 0.0, 0.5, 0.0, 0.20455077943347755, 1.0, 0.5, 0.0]
